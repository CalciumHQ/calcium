...
var NewInstanceView = (function () {
    ...
    NewInstanceView = __decorate([
        core_1.Component({
            ...
            directives: [router_2.RouterLink, action_bar_1.ActionBar],
        ...
        __metadata('design:paramtypes', [common_1.FormBuilder, router_1.Router, instance_service_1.InstanceService, template_service_1.TemplateService])
    ], NewInstanceView);
