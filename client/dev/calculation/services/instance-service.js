...
var InstanceService = (function () {
    ...
    InstanceService.prototype.getTemplate = function (id) {
        var headers = new http_1.Headers();
        headers.append('Content-Type', 'application/json');
        return this._http
            .get(InstanceService.TEMPLATE_ENDPOINT.replace(':id', id), { headers: headers })
            .map(function (r) { return r.text(); });
    };
    InstanceService.ENDPOINT = '/api/instances/:id';
    InstanceService.TEMPLATE_ENDPOINT = '/api/instances/:id/template';
